(() => {
    var t = {
            487: function () {
                ...
                window.tram = (function (t) {
                    ...
                    function o(t, e, n) {
                        ...
                        var i = n;
                        return (
                            Y.test(t) || !K.test(t) ? (i = parseInt(t, 10)) : K.test(t) && (i = 1e3 * parseFloat(t)),
                            0 > i && (i = 0),
                            i == i ? i : n
                        );
                    }
                    ...
                    if (q.transition) {
                        var T = q.timing.dom;
                        if (((L.style[T] = h["ease-in-back"][0]), !L.style[T])) for (var M in f) h[M][0] = f[M];
                    }
                    var S = (e.frame =
                            (s =
                        ...
                        j = (e.now =
                            (c = (u = d.performance) && (u.now || u.webkitNow || u.msNow || u.mozNow)) && q.bind
                                ? c.bind(u)
                                : Date.now ||
                                  function () {
                                      return +new Date();
                            ...
                            function i(t, e, i) {
                                if (t) {
                                    ...
                                    if (
                                        ...
                                        return (
                                            (this.timer = new B({ duration: t, context: this, complete: r })),
                                            void (this.active = !0)
                                        );
                                    if ("string" == a && e) {
                                        switch (t) {
                        ...
                        D = l(function (e) {
                            function o() {
                                var t,
                                    ...
                                    n,
                                    i = u.length;
                                if (i) for (S(o), e = j(), t = i; t--; ) (n = u[t]) && n.render(e);
                            }
                                ...
                                (e.stop = function () {
                                    ...
                                    this.active &&
                                        ...
                                        (n = t.inArray(this, u)) >= 0 &&
                                            ((e = u.slice(n + 1)), (u.length = n), e.length && (u = u.concat(e))));
                                }),
                                (e.render = function (t) {
                                    var e,
                                        n = t - this.start;
                    ...
                    q.transform &&
                        ...
                        q.transform &&
                            q.backface &&
                            ((Z.z = [y, "translateZ"]), (Z.rotateZ = [x]), (Z.scaleZ = [w]), (Z.perspective = [g]));
                    var Y = /ms/,
                        K = /s|\./;
                    return (t.tram = e);
                })(window.jQuery);
                ...
                ((i = {}).VERSION = "1.6.0-Webflow"),
                        ...
                        i.forEach =
                            function (t, e, n) {
                                ...
                                if (l && t.forEach === l) t.forEach(e, n);
                                    ...
                                    for (var o = 0, a = t.length; o < a; o++) if (e.call(n, t[o], o, t) === r) return;
                                } else
                    ...
                    (i.template = function (t, e, n) {
                        ...
                        var r,
                            o = RegExp(
                                [
                                    ((e = i.defaults({}, e, i.templateSettings)).escape || b).source,
            ...
            949: function (t, e, n) {
                ...
                function w(t) {
                    o.env() &&
                        (f(t.design) && l.on("__wf_design", t.design), f(t.preview) && l.on("__wf_preview", t.preview)),
