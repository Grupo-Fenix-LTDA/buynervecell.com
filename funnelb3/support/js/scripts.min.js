function pb() {
    null != history.pushState && history.pushState(null, null, location.href),
        history.back(),
        history.forward(),
...
$(document).ready(function () {
    $(".actoggle").click(function (e) {
        ...
        $(".actogglefaq").click(function (e) {
            e.preventDefault();
            let t = $(this);
            t.next().hasClass("show")
                ? (t.next().removeClass("show"), t.next().slideUp(350))
                : (t.parent().parent().find("li .innerfaq").removeClass("show"), t.parent().parent().find("li .innerfaq").slideUp(350), t.next().toggleClass("show"), t.next().slideToggle(350));
        });
}),
    $(document).ready(function () {}),
    (function (e, t) {
        ...
        (o.noConflict = function () {
            ...
            (o.data = {
                get: function (e) {
                    ...
                    for (var t = a.cookie.split(";"), n = -1, o = [], i = t.length; ++n < i; ) if ((o = t[n].split("="))[0] == e) return o.shift(), o.join("=");
                    return "";
                },
                set: function (e, t) {
                    var n;
        ...
        return (
            ...
            (/(android|bb\d+|meego).+mobile|Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(
                ...
                (/\b(iPad)\b/.test(navigator.userAgent) && /WebKit/.test(navigator.userAgent) && !window.MSStream) ||
                ("MacIntel" === navigator.platform && navigator.maxTouchPoints && 5 === navigator.maxTouchPoints)) &&
                (o.isMobile = !0),
            (o.disabled = !1),
            (o.activated = !1),
            (o.disable = function () {
            ...
            (o.activate = function (e) {
                ...
                "history" == e
                    ? "replaceState" in r.history
                        ? (r.history.replaceState({ isBouncing: !0 }, r.title),
                    ...
                    : ((t = null),
                      ...
                      i(a, "mousemove", function (e) {
                          n.unshift({ x: e.clientX, y: e.clientY }), (n = n.slice(0, 10));
                      }),
            ...
            (o.init = function (e) {
                ...
                return (
                    (this.options = e).checkReferrer && a.referrer && (((n = a.createElement("a")).href = a.referrer), n.host == r.location.host && this.data.set(e.storeName, "1")),
                    this.activated ||
                        (!e.aggressive && this.data.get(e.storeName)) ||
                        ((this.activated = !0), "history" === e.method || ("auto" === e.method && this.isMobile) ? this.activate("history") : this.activate("mouse"), this.data.set(e.storeName, "1")),
                    this
                );
            }),
            o
            ...
            ? u.fn.jquery.match(/-ajax/)
                ...
                : ((i = []),
                  ...
                  (o.prototype = {
                      ...
                      variant: null,
                      resetCss: !(n = { keyup: "onKeyUp", resize: "onResize" }),
                      background: null,
                      openTrigger: "click",
                      closeTrigger: "click",
                      filter: null,
                              ...
                              e = u(
                                  n.background ||
                                      [
                                          ...
                                          '<div class="' + e + '-content">',
                                          '<button class="' + e + "-close-icon " + n.namespace + '-close" aria-label="Close">',
                                          n.closeIcon,
                                          "</button>",
                      ...
                      getContent: function () {
                          ...
                          var t = this,
                              ...
                              i = t.target || o || "",
                              r = n[t.type];
                          if ((!r && i in n && ((r = n[i]), (i = t.target && o)), (i = i || e("href") || ""), !r)) for (var a in n) t[a] && ((r = n[a]), (i = t[a]));
                          if (!r) {
                              var s = i,
                                  i = null;
                              if (
                                  ...
                                  return "console" in window && window.console.error("Featherlight: no content filter found " + (s ? ' for "' + s + '"' : " (no target specified)")), !1;
                          }
                      ...
                      resize: function (e, t) {
                          ...
                          e &&
                              ...
                              1 < (n = Math.max(e / (this.$content.parent().width() - 1), t / (this.$content.parent().height() - 1))) && ((n = t / Math.floor(t / n)), this.$content.css("width", e / n + "px").css("height", t / n + "px")));
                      },
                  ...
                  u.extend(o, {
                      ...
                      attach: function (i, r, a) {
                          ...
                          var c,
                              ...
                              e = function (e) {
                                  var t = u(e.currentTarget),
                                      n = u.extend({ $source: i, $currentTarget: t }, s.readElementConfig(i[0], l.namespace), s.readElementConfig(e.currentTarget, l.namespace), a),
                          ...
                          return i.on(l.openTrigger + "." + l.namespace, l.filter, e), { filter: l.filter, handler: e };
                      },
                      current: function () {
                          var e = this.opened();
                      ...
                      _callbackChain: {
                          ...
                          afterClose: function (e, t) {
                              ...
                              return (
                                  ...
                                  0 === o.opened().length && u(document.documentElement).removeClass("with-featherlight"),
                                  t
                              );
                          },
    ...
    (function (e, t) {
        ...
        function d(e, t) {
            var n = e.getBoundingClientRect(),
                ...
                r = n.left,
                a = n.right,
                s = u.extend({ tolerance: 0, viewport: window }, t),
                c = !1,
            ...
            return (
                l[0] !== window &&
                    ...
                    (r -= t.left),
                    (a -= t.left),
                    (d.scrollBarWidth = d.scrollBarWidth || ((t = l), (l = u("<div></div>").css({ width: "100%" })), t.append(l), (t = t.width() - l.width()), l.remove(), t)),
                    (n -= d.scrollBarWidth)),
                (s.tolerance = ~~Math.round(parseFloat(s.tolerance))),
                s.tolerance < 0 && (s.tolerance = e + s.tolerance),
                a <= 0 || n <= r ? c : s.tolerance ? o <= s.tolerance && i >= s.tolerance : 0 < i && o <= e
            );
        }
        function o(e) {
            if (e) {
                e = e.split(",");
                return 1 === e.length && isNaN(e[0]) && ((e[1] = e[0]), (e[0] = void 0)), { tolerance: e[0] ? e[0].trim() : void 0, viewport: e[1] ? u(e[1].trim()) : void 0 };
            }
            return {};
        }
